...
## The Triples Data
In the directories of datasets fb15k237, wn18rr and yago3-10, there are text file named triples. This file including the all triples in training set, validing set and testing set. This is because our model is under the assumption of close world, the entity and relation out of knowledge graph is incapable of link predicting.
