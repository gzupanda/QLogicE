...
class Accuracy:
  ...
  def computeMetrics(self, rankAccLst):
    ...
    result['Hit@1%'] = r1 * 100.00/len(rankAccLst)
    result['Hit@2%'] = r2 * 100.00/len(rankAccLst)
    result['Hit@3%'] = r3 * 100.00/len(rankAccLst)
    result['Hit@5%'] = r5 * 100.00/len(rankAccLst)
    result['Hit@10%'] = r10 * 100.00/len(rankAccLst)
    return result
